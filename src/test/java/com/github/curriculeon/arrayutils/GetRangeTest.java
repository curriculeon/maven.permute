package com.github.curriculeon.arrayutils;

import org.junit.Test;
import com.github.curriculeon.IntegerArrayUtils;
import com.github.curriculeon.TestUtilities;
...
public class GetRangeTest {
    ...
    public void test1() {
        ...
        Integer[] actual = IntegerArrayUtils.getRange(start, end);
